...
// Verify tenant belongs to this manager's PG
$stmt = $pdo->prepare("
    SELECT b.id FROM bookings b
    WHERE b.tenant_id = ? AND b.pg_id = ?
");
$stmt->execute([$tenant_id, $pg_id]);
if(!$stmt->fetch()) {
    header('Location: tenants.php');
    exit;
}
...
$stmt = $pdo->prepare("
    ...
    WHERE u.id = ? AND b.status = 'confirmed'
");
            ...
            <div class="details-container">
                ...
                <div class="section">
                    ...
                    <div class="detail-row">
                        ...
                        <span class="detail-value"><?php echo date('d M Y', strtotime($tenant['registered_date'])); ?></span>
                    </div>
                </div>
                ...
                <div class="section">
                    ...
                    <div class="detail-row">
                        ...
                        <span class="detail-value">₹<?php echo number_format($tenant['rent_amount'] ?? 0); ?></span>
                    </div>
                    <div class="detail-row">
